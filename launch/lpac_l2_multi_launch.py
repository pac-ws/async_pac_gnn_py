...
def launch_setup(context, *args, **kwargs):
    ...
    for i in range(1, num_robots + 1):
        # Create LPAC_L2 node for each robot
        lpac_node = Node(
...
def generate_launch_description():
    ...
    num_robots_arg = DeclareLaunchArgument(
        'num_robots',
        description='Number of robots to spawn LPAC_L2 nodes for'
    )
...
# ros2 launch async_pac_gnn_py lpac_l2_multi_launch.py num_robots:=3

# With custom parameters
# ros2 launch async_pac_gnn_py lpac_l2_multi_launch.py num_robots:=5 ns_prefix:=robot params_file:=/path/to/custom/params.toml

# With custom remappings
# ros2 launch async_pac_gnn_py lpac_l2_multi_launch.py num_robots:=2 remap_robot_poses:=/custom/robot_poses
################################################################################
